...
export default class UIHandler {
  ...
  buildZones() {
    this.scene.dropZone = this.zoneHandler.renderZone(470, 500, 850, 230);
    this.scene.dropZone.setData({
      'cards': 0
    });

    this.zoneHandler.renderOutline(this.scene.dropZone, 4, 0xff69b4);
  }
  ...
  buildGameText() {
    ...
    this.scene.opponentVariablesValue = this.scene.add.text(1090, 420, '0').setFontSize(14).setFontFamily('Trebuchet MS');
    ...
    this.scene.playerVariablesValue = this.scene.add.text(1068, 500, '0').setFontSize(14).setFontFamily('Trebuchet MS');
  }
